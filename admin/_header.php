    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light prevent-select">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="page_galeri.php">Gallery</a>
                </li>
            </ul>
			<div class="dropdown">
				...
				<div class="dropdown-menu dropdown-menu-right text-right" aria-labelledby="dropdownMenuButton">
					<a class="dropdown-item" style="cursor: pointer;" onclick="javascript: window.location = 'page_user.php'">Account Management</a>
					<a class="dropdown-item" style="cursor: pointer;" onclick="javascript: window.location = 'user_edit.php?id=<?= $_SESSION['id'] ?>'">Account Setting</a>
					<a class="dropdown-item" style="cursor: pointer;" onclick="javascript: window.location = 'logout.php'">Logout</a>
				</div>
			</div>
        </div>
    </nav>
