            ...
            <table class="table table-bordered mt-3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src = "<?= "img_artikel/" . $row['gambar'] ?>" width="220" height="120"></td>
                        <td>
                            <?= $row['nama_user'] ?>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <a class="badge badge-danger" style="padding:15px" href="galeri_delete.php?id=<?= $row['id'] ?>"
            ...
            <form action="galeri_add.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <select name="id_user" class="form-control" required>
                            ...
                            <?php
                            $tampil = mysqli_query($con, "SELECT * FROM user"); foreach ($tampil as $row): ?>
                    ...
                    <div class="form-group">
                        <button type="button" class="btn btn-danger " data-dismiss="modal"
                            onclick="self.history.back()">Close</button>
